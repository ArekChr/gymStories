    ...
    defaultNavigationOptions: ({ navigation }) => ({
      tabBarIcon: ({ tintColor }: any) => {
        ...
        switch (routeName) {
          ...
          case "HomeTab":
            return (
              <Entypo name="home" size={25} color={tintColor || undefined} />
            );
          case "ActiveTab":
            return (
          ...
          case "MeasureTab":
            return (
              <Entypo name="ruler" size={25} color={tintColor || undefined} />
            );
          case "ProfileTab":
            return (
              <Entypo name="user" size={26} color={tintColor || undefined} />
            );
          default:
            return null;
        }
