      ...
      return (
        <TouchableOpacity onPress={() => this.props.onProfileClick(profile)} key={profile.profileId}>
          <View style={[{ flexDirection: 'row', padding: 10, alignItems: 'center' }]}>
            ...
            <TouchableOpacity
              onPress={() =>
                profile.following ? this.onUnfollowClick(profile.profileId) : this.onFollowClick(profile.profileId)
              }
              style={[
                {
                  width: 100,
            ...
            >
              <Text
                style={[
                  { paddingLeft: 5, paddingRight: 5, fontSize: 13, color: 'black' },
                  profile.following ? null : { fontWeight: 'bold', color: 'white' },
                ]}
                numberOfLines={1}
                ellipsizeMode='tail'
              >
