...
import { ButtonNext, TitleComponent, ErrorMessage } from '../../components'
import styles from '../../styles'
import { setGender } from '../../redux/profile/actions'
      ...
      <View style={styles.registerContainer}>
        ...
        <View style={{ flexDirection: 'column' }}>
          <View style={{ flexDirection: 'row' }}>
            <CheckBox value={this.state.gender === 'Male' ? true : false} onValueChange={() => this.onSelectMale()} />
