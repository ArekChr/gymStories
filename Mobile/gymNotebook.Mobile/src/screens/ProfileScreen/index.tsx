                ...
                <View style={{ flexDirection: 'row', paddingTop: 7, paddingRight: 15 }}>
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      following ? null : { backgroundColor: '#039BE5', borderColor: '#039BE5' },
                    ]}
                  >
                    <Text
                      style={[
                        { paddingLeft: 5, paddingRight: 5 },
                        following ? null : { fontWeight: 'bold', color: 'white' },
                      ]}
                      numberOfLines={1}
                      ellipsizeMode='tail'
                    >
                  ...
                  >
                    <Text style={{ paddingLeft: 5, paddingRight: 5 }} numberOfLines={1} ellipsizeMode='tail'>
                      Wyślij wiadomość
                    </Text>
                  </TouchableOpacity>
                </View>
