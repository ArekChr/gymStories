  ...
  renderOverlay() {
    ...
    return (
      <View style={styles.overlay}>
        <Animated.Image source={require('../../images/heart.png')} style={imageStyles} />
      </View>
    )
  }
          ...
          <DoubleTap onDoubleTap={this.toggleLike}>
            <View>
              ...
              <FastImage
                ...
                style={{ width: window.width, height }}
          ...
          <View style={{ padding: 12 }}>
            <View style={{ flexDirection: 'row', alignContent: 'center', marginBottom: 5 }}>
              <TouchableOpacity onPress={() => this.toggleLikeIcon()} style={[{ ...styles.icon }]}>
                {this.state.liked ? (
                  <FontAwesome name='heart' size={26} color='rgb(178,0,0)' />
                ) : (
            ...
            {post.commentCount > 0 ? (
              <TouchableOpacity>
                <Text onPress={() => this.onCommentClick()} style={{ marginTop: 3, marginBottom: 2 }}>
                  Zobacz wszystkie komentarze: {post.commentCount}
                </Text>
              </TouchableOpacity>
            ) : null}
